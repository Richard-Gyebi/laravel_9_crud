	...
	<div class="card-body">
		<form method="post" action="<?php echo e(route('students.update', $student->id)); ?>" enctype="multipart/form-data">
			...
			<div class="text-center">
				...
				<a href="<?php echo e(route('students.index')); ?>" class="btn btn-primary glyphicon glyphicon-arrow-left">Back</a>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel9_crud\larvel9_crud\resources\views/edit.blade.php ENDPATH**/ ?>